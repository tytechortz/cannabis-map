    ...
    if value == False:
        return html.Div([
            dcc.RadioItems(id='categories', options=[
                        ...
                        {'label':'Infused Product Mfg.','value':'MED Licensed Infused Product Manufacturer'},
                        ...
                        {'label':'Retail Marijuana Product Mfg.','value':'MED Licensed Retail Marijuana Product Manufacturer'},
